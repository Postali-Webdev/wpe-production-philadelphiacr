 ...
 */
	...
	function postali_child() {
		...
		wp_register_style( 'icomoon', 'https://cdn.icomoon.io/152819/Fienman-PostaliCore/style.css?vvbtvp', array() );
	...
	function postali_child_register_nav_menus() {
		register_nav_menus(
			array(
                ...
                'utility-nav' => __( 'Utility Navigation', 'postali' ),
                'sidebar-nav-bucks' => __( 'Location - Bucks County', 'postali' ),
                'sidebar-nav-delaware' => __( 'Location - Delaware County', 'postali' ),
                'sidebar-nav-montgomery' => __( 'Location - Montgomery County', 'postali' ),
                'sidebar-nav-downtown' => __( 'Location - Downtown', 'postali' ),
			)
		);
	}
