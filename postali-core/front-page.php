        ...
        <div class="container">
            <div class="columns">
                ...
                <div class="column-33" id="results_slider">
                    ...
                    <?php get_template_part('block','hp-awards'); ?>
                ...
                <div class="column-66 center">
                    ...
                    <div class="form-box">
                        <form class="search" role="search" action="/" method="get">
                            <label class="screen-reader-text" for="search-input-66709bbe71148">Search for:</label>
                            <input id="search-input-66709bbe71148" name="s" type="text" value="" placeholder="Type your offense here...">
